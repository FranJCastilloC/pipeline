...
from loading.BB_RFVTransPuestoBolsaMP_import import insert_data
...
if __name__ == "__main__":
    # Extraer datos
    datos = data_manager("2025-02-03", "2025-02-18")
    ...
    # Mostrar resultados
    if "BB_RFVTransPuestoBolsaMP" in consolidated_datos:
        print("\nBB_RFVTransPuestoBolsaMP consolidado:")
        print(consolidated_datos["BB_RFVTransPuestoBolsaMP"].head())